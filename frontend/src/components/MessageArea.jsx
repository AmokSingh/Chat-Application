    ...
    >
      {selectedUser && (
        <div className="w-full h-[100vh] flex flex-col">
          ...
          <div className="w-full h-[76vh] felx flex-col overflow-auto">
            {showPicker && (
      ...
      {selectedUser && (
        <div className="absolute bottom-3 left-0 right-0 ">
          ...
          >
            ...
            <button className="h-[7vh] lg:w-[9vh] md:w-[10vh] w-[11vh] bg-[#6C63FF] rounded-full flex items-center justify-center ml-2 mr-1 cursor-pointer">
